...
self.addEventListener("fetch", (evento) => {
  ...
  // Nunca cachear chamadas ao Firebase/Firestore — sempre buscar
  // a versão mais nova dos agendamentos na rede (o SDK do Firestore já
  // cuida da própria sincronização em tempo real e do modo offline).
